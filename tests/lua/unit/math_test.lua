return function(H, env)
	...
	H.TEST("util.frame_budget_law.submit_first_g51", function()
		...
		H.assert_true(u.FrameBudget_InputAfterSubmit())
		H.assert_true(u.FrameBudget_FollowCamAfterSubmit())
		...
		H.assert_true(late.skip_desktop)
		H.assert_true(late.skip_collect)
