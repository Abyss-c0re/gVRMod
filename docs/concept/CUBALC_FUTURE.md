# CubalC / matrix bus — future concept

**Status:** deferred. Prototypes live under `docs/concept/` and `addon/.../concept/`.

Not required for gVRMod OpenXR, WiVRn, CubeUI, or GMod addon ship.
