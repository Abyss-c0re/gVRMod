# Concept / prototype (not product)

Material here is **deferred research**. It is not required to build, install, or run gVRMod.

| Path | What |
|------|------|
| `CUBALC_FUTURE.md` | Why CubalC is parked; when it might return |
